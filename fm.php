...
$hidden_patterns = ['*.php','.*','Makefile','index.html','cgi-bin','icon','backup']; // Matching files hidden in directory index
...
<div id="top">   
   ...
   <?php endif; ?>
	...
	<div id="breadcrumb">&nbsp;</div>
	<div>
	<!--	<form action="./index.html" method="post" id="back" >
			<input type="submit" value="back" >
		</form>
	-->
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href=./index.html>Back  <img src=icon/back-arrow.png  width=50>  Back<a/>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href=restart.php>Restart  <img src=icon/Restart.jpg width=50 >  Restart</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href=./backup.php>Backup  <img src=icon/backup.jpg  width=50>  Backup<a/>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href=./restore.php>Restore from backup  <img src=icon/restore.png  width=50>  Restore<a/>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	</div>
</div>
...
<footer><h3>For Pete and Chris only</h3>
<a href=reboot.php><img src=icon/letter_R.png width="50" height="50"></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href=halt.php><img src=icon/letter_H.png width="50" height="50"></a>
</footer>
</body></html>
